                        ...
                        <div class="col-xs-6">
                            ...
                            <form action="" method="post">
                                <div class="input-group input-group-lg">
                                    <input type="text" name="cat_title" value="" class="form-control" placeholder="Add a Category"> </div><br>
                                <div class="btn-group btn-group-lg">
                                    <input type="submit" name="submit"  class="btn btn-primary" value="Add Category"> </div><br>
                            </form><br>
                        </div>
                        <?php //update category
