            ...
            <table class="table table-striped table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left" width="80%">
                                            <input class="form-control" id="date" name="user_birthday" placeholder="<?php echo $user_birthday; ?>" value="<?php echo $user_birthday; ?>" type="date" min="1996-01-01" >
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-left" width="19%">
                    ...
                    <div class="form-group">
                            <input class="btn btn-primary" type="submit" name="edit_profile" value="Update User">
                             <!-- <input type="submit" formaction="demo_admin.php" value="Submit as admin"> </div> -->
</form>
