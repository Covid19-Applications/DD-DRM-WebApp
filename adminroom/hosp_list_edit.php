...
if(isset($_POST['edit_btn']))
{
    ...
    $query = "SELECT * FROM hosp_list WHERE id='$id' ";
    ...
    foreach($query_run as $row)
    {
        ?>
          ...
          <form action="code.php" method="POST">
              ...
              <a href="hosp_list.php" class="btn btn-danger" > CANCEL  </a>
              <button type="submit" name="updatehospitalsbtn" class="btn btn-primary"> Update </button>
