...
<form method="post" class="responsive" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
...
function newUser()
{
	...
	//	header( "Refresh:3; url=adddoctor.php");
		  echo "<script type='text/javascript'>document.location='adddoctor.php';</script>";
